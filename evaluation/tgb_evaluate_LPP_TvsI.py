...
def eval_LPP_TGB_TvsI(model_name: str, model: nn.Module, neighbor_sampler: NeighborSampler, evaluate_idx_data_loader: DataLoader,
                evaluate_data: Data,  negative_sampler: object, evaluator: Evaluator, metric: str = 'mrr',
                split_mode: str = 'test', k_value: int = 10, nodebank: NodeBank = None, 
    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader_tqdm):
            ...
            for idx, neg_batch in enumerate(neg_batch_list):
                ...
                if nodebank.query_node(batch_src_node_ids[idx]):
